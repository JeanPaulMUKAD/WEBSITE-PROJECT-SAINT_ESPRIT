...
<section class="login wow fadeInDown" data-wow-delay="0.8s" data-wow-duration="1.2s">
  <form action="assets/pages/formulaire.php" method="GET">
    ...
    <select name="cev" class="box" required>
      <option value="">Choisir une C.E.V d'appartenance</option>
      <option value="Cev Anaurite">Cev Anaurite</option>
      <option value="Cev Bakanja">Cev Bakanja</option>
      <option value="Cev Bakhita">Cev Bakhita</option>
      <option value="Cev Bethanie">Cev Bethanie</option>
      <option value="Cev Coeur Im.">Cev Coeur Im.</option>
      <option value="Cev St Charles L.">Cev St Charles L.</option>
      <option value="Cev St Ignace">Cev St Ignace</option>
      <option value="Cev St Kizito">Cev St Kizito</option>
      <option value="Cev St Vincent de Paul">Cev St Vincent de Paul</option>
      <option value="Cev St Therese">Cev St Therese</option>
    </select>
  
    <select name="nature" class="box" required>
