    ...
    try {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['submit'])) {
            ...
            if ($userExists) {
                ...
                $sql = "INSERT INTO visiteurs (nom, mail, adresse, cev, phone) VALUES (:nom, :mail, :adresse, :cev, :phone)";
            ...
            if ($stmt->execute()) {
                ...
                if (mail($to, $subject, $message, $headers)) {
                    ...
                    echo '<div style="color: red; text-align: center; font-size: 15px; font-family: \'Poppins\', sans-serif;">Les données ont été enregistrées, mais l\'envoi de l\'e-mail a échoué.</div>';
                }
            } else {
