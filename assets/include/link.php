      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"> 
          <a class="navbar-brand"
           ...
           href="index.php?search=acceuil"><h2>PAROISSE<em class="auto-type"> S.E</em></h2>
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item <?php if (isset ($_GET["search"]) and $_GET["search"] == 'acceuil')
              {echo 'active';}
              elseif (isset ($_GET["search"]) and $_GET["search"] == 'NULL'){echo 'active';}?> ">
